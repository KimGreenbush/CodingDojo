...
const getMaxServing = (recipe, available) => Math.min(...Object.entries(recipe).map(([key, val]) => available[key] / val)) || 0;

// {firstName: Brendan, lastName: Stanton}
// [[firstName, Brendan], [lastName, Stanton]]
...
// 			minServings = 0;
// 		} else {
// 			if (Math.floor(available[key] / recipe[key]) < minServings) {
// 				minServings = Math.floor(available[key] / recipe[key]);
// 			}
// 		}
// 	}
// 	return minServings;
